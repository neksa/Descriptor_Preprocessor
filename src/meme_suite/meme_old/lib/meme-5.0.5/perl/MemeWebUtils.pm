...
use lib qw(/home/yincp/Desktop/Predictive_for_efhand/src/preprocessing/meme_suite/meme/lib/meme-5.0.5/perl);
...
unless ($@) {
  Log::Log4perl::init('/home/yincp/Desktop/Predictive_for_efhand/src/preprocessing/meme_suite/meme/share/meme-5.0.5/logging.conf');
  $logger = Log::Log4perl->get_logger('meme.service.utils');
}

my $service_invocation_log_dir = '/home/yincp/Desktop/Predictive_for_efhand/src/preprocessing/meme_suite/meme/var/meme-5.0.5/LOGS';
my $tmpdir = '';
...
sub update_status {
  ...
  my $template = HTML::Template->new(filename => '/home/yincp/Desktop/Predictive_for_efhand/src/preprocessing/meme_suite/meme/share/meme-5.0.5/job_status.tmpl');
